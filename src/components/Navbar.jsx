      ...
      >
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-12">
          <div className="flex items-center justify-between h-16 sm:h-20">
            ...
            <button 
              onClick={scrollToTop} 
              className="text-lg font-bold tracking-tight text-white logo-button sm:text-xl"
            >
              DESIGNCLAVE
            </button>
            ...
            <nav className="items-center justify-center flex-1 hidden space-x-2 lg:flex navbar-nav">
              {[
                ...
                <button
                  key={index}
                  onClick={item.action}
                  className="px-2 py-1.5 text-xs font-medium text-white transition-colors duration-300 bg-transparent border-none shadow-none hover:text-lime-400 focus:outline-none focus:ring-0 sm:px-3 sm:text-sm"
                >
                  {item.label}
                </button>
              ))}
              ...
              <nav className="py-4 space-y-2 border-t border-gray-800/30">
                {[
                  ...
                  <button
                    key={index}
                    onClick={item.action}
                    className="block w-full px-3 py-2 text-sm font-medium text-left text-white transition-colors duration-300 bg-transparent border-none rounded-lg shadow-none hover:text-lime-400 hover:bg-white/5 focus:outline-none focus:ring-2 focus:ring-lime-400/50"
                  >
                    {item.label}
                  </button>
                ))}
